...
promptQuestions = [
  {
    question:"Write a thankyou note to my father",
    icon:"fa-solid fa-wand-magic-sparkles",
  },
  {
    question:"Write a sample code of javascript",
    icon:"fa-solid fa-code",
  },
  {
    question:"How to become a full-stack devlopment",
...
window.addEventListener("load",()=>{
  promptQuestions.forEach(data => {
    ...
    item.innerHTML = `<div class="promtSuggestion">
    <p>${data.question}</p>
...
function getGeminiResponse(question,appendHistory){
    ...
    <img src="https://t4.ftcdn.net/jpg/01/66/10/03/360_F_166100342_KbTGIRrnrlwGDZSXSMpH3zfn2dxyTKae.jpg">
    <p>${question}</p>
    </div>`;

    let resultData = `
    <div class = "resultData">
    <img src="https://thumbs.dreamstime.com/b/cartoon-star-superhero-isolated-white-97300319.jpg" />
    <div class="loader">
    ...
    const AIURL = `https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyA2sbTynt4vq37uDPeQGyxPpP0Ud81rds8`
